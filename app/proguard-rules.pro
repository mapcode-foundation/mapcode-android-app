...
# AGP 9 makes R8 missing-class references a build-failing error (was a warning under AGP 8).
# These classes are referenced by the transitive org.apache.logging.log4j dependency's
# JMX / OSGi / java.beans / javax.script codepaths, which are not present on Android and
# are not exercised by this app. Suppress the warnings (rules auto-generated by AGP).
